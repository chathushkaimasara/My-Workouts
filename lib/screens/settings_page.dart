...
import 'theme_selection_page.dart'; // Ensure this matches your file structure
                  ...
                  child: ListView(
                    ...
                    children: [
                                ...
                                children: [
                                  Expanded(
                                    child: BouncingWidget(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: const Image(image: ResizeImage(AssetImage('assets/github_button.png'), width: 400), fit: BoxFit.fitWidth),
                                      ),
                                    ),
                                  ),
                                  const SizedBox(width: 15),
                                  Expanded(
                                    child: BouncingWidget(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(12),
                                        child: const Image(image: ResizeImage(AssetImage('assets/kofi_button.png'), width: 400), fit: BoxFit.fitWidth),
                                      ),
                                    ),
                                  ),
                                ],
                      ...
                      Center(
                        child: Text(
                          _appVersion, 
                          style: TextStyle(color: subTextColor.withOpacity(0.5), fontSize: 12, fontWeight: FontWeight.w500)
                        ),
                      ),
                      const SizedBox(height: 60),
                    ],
